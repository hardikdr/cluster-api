...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec,
		Convert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec,
		Convert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus,
		Convert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus,
...
func autoConvert_v1alpha1_MachineClass_To_cluster_MachineClass(in *MachineClass, out *cluster.MachineClass, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_cluster_MachineClass_To_v1alpha1_MachineClass(in *cluster.MachineClass, out *MachineClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ProviderConfig = in.ProviderConfig
	if err := Convert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec(in *MachineClassSpec, out *cluster.MachineClassSpec, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec is an autogenerated conversion function.
func Convert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec(in *MachineClassSpec, out *cluster.MachineClassSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_MachineClassSpec_To_cluster_MachineClassSpec(in, out, s)
}

func autoConvert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec(in *cluster.MachineClassSpec, out *MachineClassSpec, s conversion.Scope) error {
	return nil
}

// Convert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec is an autogenerated conversion function.
func Convert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec(in *cluster.MachineClassSpec, out *MachineClassSpec, s conversion.Scope) error {
	return autoConvert_cluster_MachineClassSpec_To_v1alpha1_MachineClassSpec(in, out, s)
}

func autoConvert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus(in *MachineClassStatus, out *cluster.MachineClassStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus is an autogenerated conversion function.
func Convert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus(in *MachineClassStatus, out *cluster.MachineClassStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_MachineClassStatus_To_cluster_MachineClassStatus(in, out, s)
}

func autoConvert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus(in *cluster.MachineClassStatus, out *MachineClassStatus, s conversion.Scope) error {
	return nil
}

// Convert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus is an autogenerated conversion function.
func Convert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus(in *cluster.MachineClassStatus, out *MachineClassStatus, s conversion.Scope) error {
	return autoConvert_cluster_MachineClassStatus_To_v1alpha1_MachineClassStatus(in, out, s)
}
